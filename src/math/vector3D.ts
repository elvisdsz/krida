export function distance3DSquared(p1: { x: number, y: number, z: number }, p2: { x: number, y: number, z: number }): number {
...
export function centroid3D(points: { x: number, y: number, z: number }[]): { x: number, y: number, z: number } {
